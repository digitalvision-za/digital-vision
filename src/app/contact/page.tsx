...
export const metadata: Metadata = {
  ...
  description: "Tell Digital Vision what a clearer website needs to change for your business.",
};
    ...
    <PublicShell>
      <section className="site-shell contact-layout">
        <div className="contact-aside">
          ...
          <p>Inquiries are saved to the Digital Vision owner dashboard. There are no automated email promises or hidden handoffs.</p>
        </div>
        <InquiryForm />
      </section>
    </PublicShell>
